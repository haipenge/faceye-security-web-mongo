		...
		<form action="<c:url value="/security/resource/save"/>" method="post" role="form" class="form-horizontal">
			...
			<fieldset>
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <fmt:message key="security.resource.name"></fmt:message>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="url"> <fmt:message key="security.resource.url"></fmt:message>
					</label>
					<div class="col-md-6">
