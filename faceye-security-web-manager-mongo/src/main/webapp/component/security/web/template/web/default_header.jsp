...
<div class="navbar-collapse collapse">
	<ul class="nav navbar-nav">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Large menu <b class="caret"></b></a>
			...
			-->
		<li><a href="<c:url value="/default/forward?forward=shop.about"/>"><fmt:message key="global.about"></fmt:message></a></li>
	</ul>
	<ul class="nav navbar-nav navbar-right user-nav">
		<c:if test="${not empty pageContext.request.userPrincipal}">
			<li class="dropdown profile_menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img
					alt="Avatar" src="<c:url value="/js/lib/clean-zone/images/avatar2.jpg"/>" /> <span> <sec:authentication
		...
		<c:if test="${empty pageContext.request.userPrincipal}">
		  ...
		  <li>
		    <a href="<c:url value="/register"/>"><fmt:message key="security.web.user.register"/></a>
		  </li>
		</c:if>
	</ul>
	<!-- 
